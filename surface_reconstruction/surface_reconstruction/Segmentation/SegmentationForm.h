...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
			...
			this->SegmentationGroup->Controls->Add(this->groupBox1);
			...
			// StartStep
			// 
			this->StartStep->Location = System::Drawing::Point(269, 69);
			...
			this->StartStepLabel->Location = System::Drawing::Point(308, 37);
			this->StartStepLabel->Name = L"StartStepLabel";
			this->StartStepLabel->Size = System::Drawing::Size(154, 13);
			this->StartStepLabel->TabIndex = 5;
			this->StartStepLabel->Text = L"начальный шаг буферизации";
			...
			this->groupBox1->Location = System::Drawing::Point(604, 17);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(290, 75);
			...
			this->GPU->Name = L"GPU";
			this->GPU->Size = System::Drawing::Size(48, 17);
			this->GPU->TabIndex = 1;
			this->GPU->TabStop = true;
			this->GPU->Text = L"GPU";
			...
			this->CPU->Name = L"CPU";
			this->CPU->Size = System::Drawing::Size(47, 17);
			this->CPU->TabIndex = 0;
			...
			this->SegmentationIteration->Location = System::Drawing::Point(87, 19);
			...
			// StartSegmentation
			// 
			this->StartSegmentation->Location = System::Drawing::Point(6, 19);
...
#pragma endregion
    ...
    private: System::Void Select_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 else
				 {
					 ...
					 CurrentSegment->RowCount = layerSelect2->segmentCount;

					 for (int j = 0; j < layerSelect2->segmentCount; j++)
					 {
						 int^ c = j;                
						 CurrentSegment->Rows[j]->Cells[0]->Value = c->ToString(); 
						 unsigned int^ count = layerSelect2->countVoxel[j];                 
						 CurrentSegment->Rows[j]->Cells[1]->Value = count->ToString(); 
						 short^ w = layerSelect2->weightSegment[j];                 
						 CurrentSegment->Rows[j]->Cells[2]->Value = w->ToString();
